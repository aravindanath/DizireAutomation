 ...
 *
 * https://mvnrepository.com/artifact/com.aventstack/extentreports/4.1.5
 *
 */
...
public class ExtentReport4Demo {
	...
	public void setExtent() {
		htmlReporter = new ExtentHtmlReporter("./test-output/myReport" + System.currentTimeMillis() + ".html");
